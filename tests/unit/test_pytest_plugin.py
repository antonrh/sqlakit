...
from sqlakit import pytest_plugin
...
def test_a_report_needs_the_debug_server(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr(importlib.util, "find_spec", lambda _: None)
    config = cast("pytest.Config", SimpleNamespace(getoption=lambda *_, **__: "r.html"))
